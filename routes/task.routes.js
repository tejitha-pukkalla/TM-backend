...
// // Task actions
// router.post('/:id/start', protect, authorize(ROLES.MEMBER), taskController.startTask);
// router.post('/:id/complete', protect, authorize(ROLES.MEMBER), taskController.completeTask);
